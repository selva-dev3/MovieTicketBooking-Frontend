...
import { dummyTrailers } from '../../public/images/assets'
...
function TrailersSection() {
    ...
    console.log('currentTrailer', currentTrailer.image)
    return (
            ...
            <div className='group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
                {
                    dummyTrailers.map((trailer) => (
                        ...
                        duration-300 transition max-md:h-60 cursor-pointer' onClick={() => setCurrentTrailer(trailer)}>
